...
class BDDDataSet(data.Dataset):
    #Default load train
    def __init__(self, root, split="train", max_iters= None, mean=(128, 128, 128)):
        self.root = root
        self.split = split
